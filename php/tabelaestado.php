...
<body class="">
    ...
    <form method="post">
        <input class="form-check-input bg-dark" type="radio" id="EstadoID" name="busca" value="EstadoID" <?php if($busca == "EstadoID"){echo "checked";}?>>
        <label for="huey"><h3>ID</h3></label>
        <br>
        <input class="form-check-input bg-dark" type="radio" id="EstadoNome" name="busca" value="EstadoNome" <?php if($busca == "EstadoNome"){echo "checked";}?>>
        <label for="huey"><h3>Nome</h3></label>
        <br>
        <input class="form-check-input bg-dark" type="radio" id="EstadoSigla" name="busca" value="EstadoSigla" <?php if($busca == "EstadoSigla"){echo "checked";}?>>
