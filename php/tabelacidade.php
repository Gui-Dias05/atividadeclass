...
<body class="">
    ...
    <form method="post">
        <input class="form-check-input bg-dark" type="radio" id="CidadeID" name="busca" value="CidadeID" <?php if($busca == "CidadeID"){echo "checked";}?>>
        <label for="huey"><h3>ID</h3></label>
        <br>
        <input class="form-check-input bg-dark" type="radio" id="CidadeNome" name="busca" value="CidadeNome" <?php if($busca == "CidadeNome"){echo "checked";}?>>
